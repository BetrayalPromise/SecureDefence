...
- (NSArray <id> *)safe {
    if (!self.isSafe) {
        ...
        class_addMethod(kClass, @selector(enumerateObjectsAtIndexes:options:usingBlock:), (IMP)safeEnumerateObjectsAtIndexesOptionsUsingBlock, method_getTypeEncoding(class_getInstanceMethod([self class], @selector(enumerateObjectsAtIndexes:options:usingBlock:))));
        class_addMethod(kClass, @selector(indexOfObjectAtIndexes:options:passingTest:), (IMP)safeIndexOfObjectAtIndexesOptionspassingTest, method_getTypeEncoding(class_getInstanceMethod([self class], @selector(indexOfObjectAtIndexes:options:passingTest:))));
        class_addMethod(kClass, @selector(indexesOfObjectsAtIndexes:options:passingTest:), (IMP)safeIndexesOfObjectsAtIndexesOptionsPassingTest, method_getTypeEncoding(class_getInstanceMethod([self class], @selector(indexesOfObjectsAtIndexes:options:passingTest:))));
        class_addMethod(kClass, @selector(indexOfObject:inSortedRange:options:usingComparator:), (IMP)safeIndexOfObjectInSortedRangeOptionsUsingComparator, method_getTypeEncoding(class_getInstanceMethod([self class], @selector(indexOfObject:inSortedRange:options:usingComparator:))));
